...
export const Newsletter = () => {
  ...
  const EmailMessage = (props: any) => {
    ...
    if (emailSubmitted) {
      return (
        <p className="mt-3 text-sm text-grayscale-400 dark:bg-zinc-400">
          {" "}
    ...
    return (
      <p className="hidden mt-3 text-sm text-grayscale-400 dark:bg-zinc-400">
        {" "}
        We'll keep you posted!{" "}
      </p>
    );
  ...
  return (
    <section className="py-16 dark:bg-zinc-900">
      <div className="px-4 mx-auto max-w-7xl sm:px-6">
        {/* CTA box */}
        <div
          className="relative px-8 py-10 overflow-hidden border rounded shadow-2xl border-grayscale-400 bg-grayscale-900 md:py-16 md:px-12"
          data-aos="zoom-y-out"
        >
          ...
          <div className="relative flex flex-col items-center justify-between lg:flex-row">
            ...
            <div className="text-center lg:text-left lg:max-w-xl">
              ...
              <p className="mb-6 text-lg text-grayscale-300 dark:text-zinc-400">
                By joining our waitlist, you'll be the first to see our product.
              ...
              >
                <div className="flex flex-col justify-center max-w-xs mx-auto sm:flex-row sm:max-w-md lg:mx-0">
                  <input
                    type="email"
                    className="w-full px-4 py-3 mb-2 text-white border rounded-lg appearance-none placeholder-grayscale-500 bg-grayscale-800 border-grayscale-700 form-input focus:border-grayscale-600 sm:mb-0 sm:mr-2"

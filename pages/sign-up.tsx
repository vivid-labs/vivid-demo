            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto">
                <form>
                  ...
                  <div className="mt-3 text-sm text-center text-grayscale-500">
                ...
                <div className="flex items-center my-6">
                  <div
                    className="flex-grow mr-3 border-t border-grayscale-300"
                    aria-hidden="true"
                  ></div>
                  <div className="italic text-grayscale-600">Or</div>
                  <div
                    className="flex-grow ml-3 border-t border-grayscale-300"
                    aria-hidden="true"
                  ></div>
                </div>
                <form>
                  <div className="flex flex-wrap mb-3 -mx-3">
                    <div className="w-full px-3">
                      <button className="relative flex items-center w-full px-0 text-white bg-grayscale-900 btn hover:bg-grayscale-800">
                        <svg
                ...
                <div className="mt-6 text-center text-grayscale-600">
